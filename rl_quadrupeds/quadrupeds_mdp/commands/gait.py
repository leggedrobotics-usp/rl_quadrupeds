...
Command generators for quadruped gait parameters.

Available classes:
- QuadrupedGaitDutyCycleCommand: Generates gait duty cycle commands.
- QuadrupedGaitFrequencyCommand: Generates gait frequency commands.
- QuadrupedGaitStanceDistancesCommand: Generates gait stance distances commands.
- QuadrupedGaitTypeCommand: Generates gait type commands.
"""
