...
Command terms for generating position commands for quadruped robots.

Available classes:
- QuadrupedGaitFootswingHeightCommand: Generates footswing height commands for quadruped robots.
- QuadrupedBaseHeightOrientationCommand: Generates base height and orientation commands for quadruped robots.
"""
