...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    env_cfg.sim.physx.gpu_max_rigid_contact_count = 2 ** 25
    env_cfg.sim.physx.gpu_max_rigid_patch_count = 5 * 2 ** 17
    ...
    env_cfg.sim.physx.gpu_heap_capacity = 2 ** 28
    env_cfg.sim.physx.gpu_temp_buffer_capacity = 2 ** 26
