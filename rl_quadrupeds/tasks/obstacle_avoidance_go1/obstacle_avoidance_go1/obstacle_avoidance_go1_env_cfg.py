...
from .mdp.scene_cfg import Go1ObstacleAvoidanceSceneCfg
...
@configclass
class Go1ObstacleAvoidanceEnvCfg(ManagerBasedRLEnvCfg):
    scene: Go1ObstacleAvoidanceSceneCfg = Go1ObstacleAvoidanceSceneCfg(
        num_envs=512, 
        env_spacing=10.0
    )
